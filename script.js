...
function initApp() {
    ...
    function updateQureoCountdown() {
        ...
        const distance = qureoExamDate.getTime() - now;
        
        const daysEl = document.getElementById('days1');
        const hoursEl = document.getElementById('hours1');
        const minsEl = document.getElementById('minutes1');
        const secsEl = document.getElementById('seconds1');
